...
RUN mkdir -p /usr/share/java/kafka-connect-spooldir/
COPY build/spooldir/ /usr/share/java/kafka-connect-spooldir/
...
ENV CONNECT_BOOTSTRAP_SERVERS 192.168.5.31:9092
ENV CONNECT_GROUP_ID conny-group
